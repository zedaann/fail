...
/**
 * BahagianLetakKeretaSearch represents the model behind the search form of `app\models\BahagianLetakKereta`.
 */
class BahagianLetakKeretaSearch extends BahagianLetakKereta
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BahagianLetakKereta::find();
