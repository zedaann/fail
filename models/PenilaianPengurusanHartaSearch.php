...
/**
 * PenilaianPengurusanHartaSearch represents the model behind the search form of `app\models\PenilaianPengurusanHarta`.
 */
class PenilaianPengurusanHartaSearch extends PenilaianPengurusanHarta
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['Bil', 'imgid'], 'integer'],
            [['nama_fail', 'kod_fail', 'kakitangan', 'pemilik', 'penyewa', 'no_lot', 'no_tel', 'catatan', 'status', 'tarikh', 'lampiran', 'kedudukan_fail', 'jabatan', 'rak', 'tarikh_keluar', 'tarikh_hantar', 'catatan2', 'imgname', 'imgtype', 'imgsize', 'img'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianPengurusanHarta::find();
        ...
        $query->andFilterWhere(['like', 'nama_fail', $this->nama_fail])
            ...
            ->andFilterWhere(['like', 'penyewa', $this->penyewa])
