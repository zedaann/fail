...
/**
 * KorporatPentadbiranSearch represents the model behind the search form of `app\models\KorporatPentadbiran`.
 */
class KorporatPentadbiranSearch extends KorporatPentadbiran
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = KorporatPentadbiran::find();
