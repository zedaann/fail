...
/**
 * JkpPentadbiranSearch represents the model behind the search form of `app\models\JkpPentadbiran`.
 */
class JkpPentadbiranSearch extends JkpPentadbiran
{
    /**
     * {@inheritdoc}
     */
