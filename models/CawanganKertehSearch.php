...
/**
 * CawanganKertehSearch represents the model behind the search form of `app\models\CawanganKerteh`.
 */
class CawanganKertehSearch extends CawanganKerteh
{
    /**
     * {@inheritdoc}
     */
