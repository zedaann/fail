...
/**
 * JabatanLandskapSearch represents the model behind the search form of `app\models\JabatanLandskap`.
 */
class JabatanLandskapSearch extends JabatanLandskap
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['Bil', 'imgid'], 'integer'],
            [['nama_fail', 'kod_fail', 'kakitangan', 'tajuk_projek', 'pemaju', 'no_tel', 'catatan', 'status', 'tarikh', 'lampiran', 'kedudukan_fail', 'jabatan', 'rak', 'tarikh_keluar', 'tarikh_hantar', 'catatan2', 'imgname', 'imgtype', 'imgsize', 'img'], 'safe'],
        ];
    }
