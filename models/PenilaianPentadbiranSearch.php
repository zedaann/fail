...
/**
 * PenilaianPentadbiranSearch represents the model behind the search form of `app\models\PenilaianPentadbiran`.
 */
class PenilaianPentadbiranSearch extends PenilaianPentadbiran
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['Bil', 'imgid'], 'integer'],
            [['nama_fail', 'kod_fail', 'kakitangan', 'catatan', 'status', 'tarikh', 'lampiran', 'kedudukan_fail', 'jabatan', 'rak', 'tarikh_keluar', 'tarikh_hantar', 'catatan2', 'imgname', 'imgtype', 'imgsize', 'img'], 'safe'],
        ];
    }
    ...
    {
        $query = PenilaianPentadbiran::find();
